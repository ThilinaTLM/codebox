...
import { BoxOutcomeBadge } from "@/components/box/BoxStatusBadge"
...
function BoxOverviewPage() {
  ...
  const { data: events } = useBoxEvents(projectSlug, boxId, { limit: 30 })
            ...
            <div>
              ...
              {box.box_outcome && (
                <div className="mt-3 flex items-center gap-2">
                  <BoxOutcomeBadge status={box.box_outcome} />
                  {box.box_outcome_message && (
