/**
 * Create agent wizard — project-scoped.
 *
 * Two-step wizard: primary fields (Step 1) + tool configuration (Step 2).
 * On success, navigates to the new agent's detail page within the project.
 */
...
function CreateAgentPage() {
  ...
  const createMutation = useCreateBox(projectSlug)
  ...
  const { data: githubStatus } = useGitHubStatus(projectSlug)
