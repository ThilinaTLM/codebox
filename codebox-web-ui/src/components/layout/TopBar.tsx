...
import { GridViewIcon, ContainerIcon, Settings02Icon, MoreHorizontalCircle01Icon } from "@hugeicons/core-free-icons"
              ...
              <>
                ...
                {boxPageActions.isActive && (
                  <Button
                    ...
                    disabled={boxPageActions.stopPending}
                  >
                    Stop
                  </Button>
                )}
