    ...
    <Collapsible open={expanded} onOpenChange={setExpanded}>
      ...
      <CollapsibleContent>
        <div className="ml-1 border-l border-border/20 pl-3">
          ...
          {/* Diff view */}
          <div className="mt-2 mb-1 overflow-auto rounded-md bg-inset font-terminal text-xs leading-relaxed">
            {oldStr && (
          ...
          {output && output.includes("Error") && (
            <p className="mb-1 font-terminal text-xs text-destructive/70">
              {output.slice(0, 200)}
            </p>
          )}
        </div>
