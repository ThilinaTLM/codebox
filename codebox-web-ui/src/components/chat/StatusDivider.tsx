  ...
  return (
    <div className="flex items-center gap-2 py-1.5">
      ...
      <div className="flex items-center gap-1.5">
        <CheckCircle2 size={10} className="text-state-completed/80" />
...
export function ErrorBlock({ detail }: { detail: string }) {
  return (
    <div className="rounded-lg border border-state-error/20 border-l-2 border-l-state-error bg-state-error/5 px-3 py-1.5">
