  ...
  return (
    <>
      <FormField
        ...
        required
        error={errors.name}
        description="A short human-readable name. Shown in the automations list."
      >
        <Input
          id="at-name"
          value={state.name}
      ...
      <FormField
        ...
        description="Optional. Explain what this automation does. Visible only to project admins."
      >
        <Textarea
          id="at-description"
      ...
      <div className="flex items-center justify-between rounded-lg border border-border/50 bg-muted/30 p-3">
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            Disabled automations skip all matching events.
          </p>
        </div>
        <Switch
          id="at-enabled"
