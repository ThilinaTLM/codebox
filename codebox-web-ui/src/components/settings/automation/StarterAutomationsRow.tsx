...
import type { FormAction, FormState } from "./useAutomationFormState"
import type {
...
const STARTERS: ReadonlyArray<StarterPreset> = [
  {
    id: "triage-issues",
  ...
  },
  {
    ...
    patch: {
      ...
      workspace_mode: "pinned" as AutomationWorkspaceMode,
      system_prompt: DEFAULT_SYSTEM_PROMPT,
      initial_prompt:
...
interface StarterAutomationsRowProps {
  dispatch: Dispatch<FormAction>
  disabled?: boolean
}

export function StarterAutomationsRow({
  dispatch,
  disabled,
}: StarterAutomationsRowProps) {
  return (
    <div className="space-y-2">
      <div className="space-y-0.5">
        <h4 className="text-sm font-medium">Start from an example</h4>
