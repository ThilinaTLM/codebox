/**
 * Default prompt content used when seeding a brand-new automation.
 *
...
const DEFAULTS: Record<AutomationTriggerKind, string> = {
  "github.issues":
  ...
  schedule:
    ...
    "Perform the recurring task this automation is responsible for.",
}
