...
export function EmptyAutomationsState({
  projectSlug,
  readOnly,
}: EmptyAutomationsStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16">
      <div className="max-w-2xl space-y-6 rounded-2xl border border-dashed border-border/70 bg-muted/20 p-8 text-center">
        ...
        <div className="space-y-2">
          <h3 className="font-display text-lg">No automations yet</h3>
          <p className="text-sm text-muted-foreground">
            Automations spawn agents automatically from GitHub events or on a
            schedule. Here are a few ideas.
          </p>
        </div>
