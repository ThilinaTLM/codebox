"""Pydantic schemas for the agent-template service and API boundary."""
...
class AgentTemplateRunResponse(BaseModel):
    id: str
    project_id: str
    template_id: str
...
class AgentTemplateRunListResponse(BaseModel):
    runs: list[AgentTemplateRunResponse]
...
class AgentTemplateDryRunRequest(BaseModel):
...
class AgentTemplateDryRunResponse(BaseModel):
    matched: bool
