...
class GitHubWebhookDispatcher:
    ...
    async def _spawn_for_automation(
        ...
        *,
        ...
        # Resolve installation handle (lazy-store fallback for manifest-flow installs)
        ...
        title = (
            context.variables.get("ISSUE_TITLE")
            or context.variables.get("PR_NUMBER")
            or automation.trigger_kind
        )
        spawn_ctx = SpawnContext(
            ...
            base_repo=repo_full or None,
            branch_hint=context.branch_hint,
            pinned_branch=automation.pinned_branch,
            issue_number=context.issue_number,
            trigger_url=context.trigger_url,
